...
function initializeSkillCards() {
  ...
  console.log(`${skillCards.length} cartes de compétences trouvées`);
  ...
  skillCards.forEach((card, index) => {
    console.log(`Ajout des écouteurs à la carte ${index + 1}`);
    ...
    card.addEventListener('click', function(e) {
      ...
      if (activeCard && activeCard !== card) {
        console.log('Fermeture de la carte active précédente');
  ...
  console.log('Initialisation des cartes de compétences terminée');
}
