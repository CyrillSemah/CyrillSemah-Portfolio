  ...
  const openProjectModal = (projectId) => {
    ...
    setTimeout(() => {
      ...
      if (projectCard) {
        ...
        // Vérifier si le bouton existe avant d'essayer d'accéder à son href
        const secondaryBtn = projectCard.querySelector('.btn-secondary');
        const projectUrl = secondaryBtn ? secondaryBtn.href : '';
