...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.addEventListener('scroll', function() {
    ...
    const totalDistance = educationHeight;
    
    // Définir la zone de transition (jusqu'à 60% de la distance entre les sections)
    const transitionStart = educationTop + totalDistance * 0.5; // Commencer à 50% de la section Formation
    const transitionEnd = educationTop + totalDistance * 0.9; // Terminer à 90% de la section Formation
