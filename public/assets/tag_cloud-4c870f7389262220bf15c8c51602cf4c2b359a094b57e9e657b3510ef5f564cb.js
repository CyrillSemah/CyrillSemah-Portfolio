...
function loadTagCanvas() {
  ...
  if (window.TagCanvas) {
    console.log('TagCanvas déjà chargé, initialisation...');
    setTimeout(initializeTagCanvas, 100);
    return;
  }
  
  console.log('Chargement de TagCanvas...');
  ...
  script.onload = function() {
    console.log('TagCanvas chargé avec succès');
    setTimeout(initializeTagCanvas, 100);
  };
  ...
  script.onerror = function() {
    ...
    fallbackScript.onload = function() {
      console.log('TagCanvas chargé depuis le CDN alternatif');
      setTimeout(initializeTagCanvas, 100);
    };
...
function initializeTagCanvas() {
  ...
  try {
    ...
    console.log('TagCanvas initialisé avec succès');
