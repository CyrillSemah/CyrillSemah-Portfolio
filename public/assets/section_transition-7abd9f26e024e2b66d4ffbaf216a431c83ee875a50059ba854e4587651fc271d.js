...
document.addEventListener('DOMContentLoaded', function() {
  console.log('Script de transition par lignes de code chargé');
  ...
  console.log('Sections détectées:', existingSections.length);
  ...
  window.addEventListener('scroll', function() {
    ...
    if (!homeSection || !xpProSection) {
      console.log('Sections principales non trouvées');
      return;
    }
    ...
    if (scrollPosition >= transitionStart && scrollPosition <= transitionEnd) {
      ...
      console.log('Progression code:', progress);
