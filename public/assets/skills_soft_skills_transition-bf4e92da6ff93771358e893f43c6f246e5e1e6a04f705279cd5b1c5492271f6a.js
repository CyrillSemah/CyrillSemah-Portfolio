...
document.addEventListener('DOMContentLoaded', function() {
  ...
  console.log('Transition Compétences-Projets initialisée');
  ...
  window.addEventListener('scroll', function() {
    ...
    const totalDistance = projectsTop - skillsTop;
    
    // Définir la zone de transition (entre les deux sections)
    const transitionStart = projectsTop - 300; // Commencer 300px avant la section Projets
    const transitionEnd = projectsTop - 50; // Terminer 50px avant la section Projets
    
    console.log(`Scroll: ${scrollPosition}, Start: ${transitionStart}, End: ${transitionEnd}, Projects: ${projectsTop}`);
