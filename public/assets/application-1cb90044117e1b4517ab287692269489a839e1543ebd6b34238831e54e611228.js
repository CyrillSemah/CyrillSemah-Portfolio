...
import './css_fix';
import './skills_initializer'; // Initialisation des compétences
import './initializers'; // Initialisation de tous les effets
import './animation_fix'; // Correctifs pour les animations
...
import './project_form'; // Gestion du formulaire de projet dynamique
import './projects_effects'; // Effets interactifs pour les projets (réglette, carrousel, etc.)
import './grid_background_effect'; // Effet de grille d'arrière-plan
